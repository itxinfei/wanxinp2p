...
import cn.itcast.wanxinp2p.uaa.domain.IntegrationUserDetailsAuthenticationHandler;
import cn.itcast.wanxinp2p.uaa.domain.IntegrationUserDetailsAuthenticationProvider;
